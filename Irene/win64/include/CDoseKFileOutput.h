...
class DoseKFileOutput : public DataFileOutput, public DataCalcInfo
{
  public:
    void setChunkSize( int iChunkSize ) { m_iChunkSize = iChunkSize; }
    DoseKFileOutput();
    ~DoseKFileOutput();
    int setDoseFileBase ( const string& strDataFileBase, bool bBinary=false, int iBinId=-1 );
    ...
    void setDoseKernelDir ( const string& strDoseKernelDir )
      { m_strDoseKernelDir = strDoseKernelDir; }
    string getDoseKernelDir ( ) { return m_strDoseKernelDir; }

    void setDoseKernelFile ( const string& strDoseKernelFile )
      { m_strDoseKernelFile = strDoseKernelFile; }
