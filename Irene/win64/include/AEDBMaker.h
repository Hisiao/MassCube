...
Description: Class declaration for the AEDBMaker class in the database 
...
namespace ae9ap9
{
    ...
    public:
        ...
        bool foundINet() { return m_bINetRead; }
        AEDBMakerNet& getINet() { return m_iNet; }

        bool foundPhiNet() { return m_bPhiNetRead; }
        AEDBMakerNet& getPhiNet() { return m_phiNet; }
