...
File: AEKPhiSpatialCoordCalculator.h

Description: Class declaration for AEKPhiSpatialCoordCalculator, which
...
SVNTag: $Id$
******************************************************************************/
#ifndef AEKPHISPATIALCOORDCALCULATOR_H
#define AEKPHISPATIALCOORDCALCULATOR_H

#include "AENeuralNetSpatialCoordCalculator.h"

namespace ae9ap9
{
    class AEKPhiSpatialCoordCalculator : public AENeuralNetSpatialCoordCalculator
    {
    public:
        AEKPhiSpatialCoordCalculator();
        ~AEKPhiSpatialCoordCalculator();
